# Adapted from https://github.com/tensorflow/models/blob/master/research/object_detection/dataset_tools/create_pycocotools_package.sh
...
# Ugh, really ugly stuff but it works. Don't want to spend more time on this
cd "$ORIGINAL_DIR/${OUTPUT_DIR}"
tar -czf ../pycocotools-2.0.tar.gz -C "${ORIGINAL_DIR}/$OUTPUT_DIR/" ./raw/cocoapi/PythonAPI/
rm -rf raw
cd ..
rm -rf pycocotools
